...
buddy_check(void) {
    ...
    struct Page *p08 = alloc_pages(2225);
    struct Page *p09 = alloc_pages(1222);
    struct Page *p10 = alloc_pages(11289);
    assert(!PageProperty(p03));
    assert(!PageProperty(p04));
    assert(!PageProperty(p05));
    assert(!PageProperty(p06));
    assert(!PageProperty(p07));
    assert(!PageProperty(p08));
    assert(!PageProperty(p09));
    assert(!PageProperty(p10));
    free_pages(p03, 12);
    free_pages(p04, 43);
    free_pages(p05, 23);
    free_pages(p06, 87);
